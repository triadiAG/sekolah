      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../page/siswa.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>siswa</p>
                </a>
              </li>
              ...
              <?php
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_siswa" name="nama_siswa" placeholder="Nama Siswa" value="<?= $data['nama_siswa'];?>">
                  </div>
                  <div class="form-group">
